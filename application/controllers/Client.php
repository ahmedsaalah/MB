...
$this->load->model('city_model');
    ...
    function getAllCountries()
    {
           ...
           echo json_encode( $this->city_model->AllCountries());

//echo $name;


    }
        function getCitiesOfthisCountry()
    {
        $id = $this->input->get('id');
         
           echo json_encode( $this->city_model->citiesOfTheCountry($id),JSON_UNESCAPED_UNICODE);
